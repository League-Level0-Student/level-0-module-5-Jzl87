...
public class Code4Life {
	...
	public static void main(String[] args) {
		...
		String timeCoding = JOptionPane.showInputDialog("How many hours did you spend programming?");
		int hoursCoding = Integer.parseInt(timeCoding);
		
		if (hoursCoding <= 2) {
			JOptionPane.showMessageDialog(null, "Stop watching youtTube and write code instead!");
		} else if (hoursCoding >= 2 && hoursCoding <5) {
	...
	private static void playBatmanTheme() {
		...
		// below.
		if (canPlaySounds) {
			File sound = new File("src/_04_practice/_2_code_4_life/batman.wav.wav");
			if (sound.exists()) {
				new Thread(() -> {
					try {
