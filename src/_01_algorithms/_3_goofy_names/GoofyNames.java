...
public class GoofyNames {
	public static void main(String[] args) {
		...
		String stringName = JOptionPane.showInputDialog("What is your name?");
		...
		for (int i = 0; i < nameLength; i += 1) {
			char nameAt = stringName.charAt(i);
			if (i % 2 == 0) {

				goofyName += Character.toUpperCase(nameAt);
			} else if (i % 2 == 1) {
				goofyName += Character.toLowerCase(nameAt);
				;
			}
		}
